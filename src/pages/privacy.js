    ...
    <>
      ...
      <div className="mx-4 mobile:mx-0">
        <main className="mb-12">
          ...
          <p className="mt-2">
            MINEDOCS (&#39;minedocs.xyz&#39;이하 &#39;MINEDOCS&#39;)은(는)
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              ① MINEDOCS 은(는) 다음의 개인정보 항목을 처리하고 있습니다.
            </p>
            <table className="mt-4 table-auto border-collapse border border-gray-600">
              <thead>
                <tr>
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              ① MINEDOCS 은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보
              보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게
              제공합니다.
            </p>
            <p className="mt-2">
              ② MINEDOCS 은(는) 다음과 같이 개인정보를 제3자에게 제공하고
              있습니다.
            </p>
            <table className="mt-4 table-auto border-collapse border border-gray-600">
              <thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-600 px-4 py-2">
                    로그인ID, 이메일, 접속 IP 정보, 쿠키, 접속 로그, 서비스 이용
                    기록
                  </td>
                  <td className="border border-gray-600 px-4 py-2">
                    회원 탈퇴 후 최대 1개월
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              ① MINEDOCS 은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는
            ...
            <table className="mt-4 table-auto border-collapse border border-gray-600">
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-600 px-4 py-2">
                    MINEDOCS 은(는) 파기 사유가 발생한 개인정보를 선정하고,
                    MINEDOCS 의 개인정보 보호책임자의 승인을 받아 개인정보를
                    파기합니다.
                  </td>
                  <td className="border border-gray-600 px-4 py-2">
                    회원 탈퇴 후 최대 1개월
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              ① 정보주체는 MINEDOCS에 대해 언제든지 개인정보
              열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
            </p>
            <p className="mt-2">
              ② 제1항에 따른 권리 행사는MINEDOCS에 대해 「개인정보 보호법」
              시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
              통하여 하실 수 있으며 MINEDOCS은(는) 이에 대해 지체 없이
              조치하겠습니다.
            </p>
            <p className="mt-2">
            ...
            <p className="mt-2">
              ⑥ MINEDOCS은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              MINEDOCS은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
              취하고 있습니다.
            </p>
            <table className="mt-4 table-auto border-collapse border border-gray-600">
              <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-600 px-4 py-2">
                    ...
                    보관,관리하고 있으며,다만, 5만명 이상의 정보주체에 관하여
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              ① MINEDOCS은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
          ...
          <div className="mt-10">
            ...
            <p className="mt-4">
              ② 정보주체께서는 MINEDOCS(&#39;minedocs.xyz&#39;이하
              &#39;MINEDOCS&#39;) 의 서비스(또는 사업)을 이용하시면서 발생한
              모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
              개인정보 보호책임자로 문의하실 수 있습니다.
              MINEDOCS(&#39;minedocs.xyz&#39;이하 &#39;MINEDOCS&#39;) 은(는)
            ...
            <table className="mt-4 table-auto border-collapse border border-gray-600">
              ...
              <tbody>
                <tr>
                  ...
                  <td
                    className="border border-gray-600 px-4 py-2 cursor-pointer transition-all hover:text-gray-400"
                    onClick={() => router.push('https://privacy.kisa.or.kr')}
                  >
                    privacy.kisa.or.kr
                  </td>
                </tr>
                <tr>
                  ...
                  <td
                    className="border border-gray-600 px-4 py-2 cursor-pointer transition-all hover:text-gray-400"
                    onClick={() => router.push('https://kopico.go.kr')}
                  >
                    www.kopico.go.kr
                  </td>
                </tr>
                <tr>
                  ...
                  <td
                    className="border border-gray-600 px-4 py-2 cursor-pointer transition-all hover:text-gray-400"
                    onClick={() => router.push('https://spo.go.kr')}
                  >
                    www.spo.go.kr
                  </td>
                </tr>
                <tr>
                  ...
                  <td
                    className="border border-gray-600 px-4 py-2 cursor-pointer transition-all hover:text-gray-400"
                    onClick={() =>
                      router.push('https://cyberbureau.police.go.kr')
                    }
                  >
          ...
          <div className="mt-10">
            ...
            <p className="mt-2">
              ① 이 개인정보처리방침은 2023년 6월 15부터 적용됩니다.
            </p>
            <p className="mt-2">
