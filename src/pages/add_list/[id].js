      ...
      <div className="mx-4 mobile:mx-0">
        <main className="mb-12">
            ...
            <div className="grid gap-4 grid-rows-auto grid-cols-1 mobile:grid-cols-2">
              ...
              <div className="bg-[#141920] rounded-lg p-5">
                ...
                <div className="flex justify-between items-center">
                  <input
                    className="mt-4 mr-2 px-2.5 pb-1 w-full h-12 bg-[#0d1117] text-left text-white rounded-lg"
                    id="TagA"
                    type="text"
                    placeholder="예시: 가이드"
                    value={tagSetA}
                  ...
                  />
                  <input
                    className="mt-4 ml-2 px-2.5 pb-1 w-full h-12 bg-[#0d1117] text-left text-white rounded-lg"
                    id="TagB"
                    type="text"
                    placeholder="예시: 전설"
                    value={tagSetB}
          ...
          <div id="StepN" className="hidden">
            ...
            >
              {layout.map(item => (
                <div key={item.i} className="bg-[#141920] rounded-lg p-5 flex flex-col">
                  <input
                    id={`writing_a_${item.i}`}
                    ref={writing_a}
                    className="title text-2xl text-white font-bold bg-[#141920]"
                  ...
                  <textarea
                    ...
                    ref={writing_b}
                    rows="1"
                    className="content text-xl text-white font-bold bg-[#141920] -mt-3 w-full h-full resize-none"
