                                    ...
                                    <div className="mt-4 grid grid-rows-auto grid-cols-1 mobile:grid-cols-2 gap-4">
                                        ...
                                        <div className="grid gap-4 grid-cols-2 grid-rows-auto">
                                            <div className="text-center">
                                                ...
                                                <label
                                                    htmlFor="java"
                                                    className={`block bg-[#17171b] text-lg font-bold text-center rounded-lg w-full py-1.5 cursor-pointer hover:bg-blue-600 transition-all ${
                                            ...
                                            <div className="text-center">
                                                ...
                                                <label
                                                    htmlFor="bedrock"
                                                    className={`block bg-[#17171b] text-lg font-bold text-center rounded-lg px-6 py-1.5 cursor-pointer hover:bg-blue-600 transition-all ${
