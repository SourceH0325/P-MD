...
import NameInput from '@/pages/components/AddDocsNameInput';
import VersionInput from './components/AddVersionInput';
import UrlInput from './components/AddUrlInput';
import TagInput from './components/AddTagInput';
