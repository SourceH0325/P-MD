    ...
    return (
        <>
            <header className="flex justify-between items-center h-20 w-auto mx-4 mobile:mx-0">
                ...
                <div className="flex items-center">
                    ...
                    {session && (
                        <div className="relative inline-block hidden mobile:block">
                            ...
                            <div className="bg-gray-700 absolute right-0 mt-1 w-56 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 opacity-0 invisible transition-all duration-300 z-50">
                                <div
                                    className=""
                                    role="menu"
                ...
                {/* Mobile Menu */}
                <div
                    className={`fixed top-0 left-0 w-full h-full bg-[#202026] z-40 transition-all mobile:hidden ${
