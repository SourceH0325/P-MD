...
const UrlInput = () => {
  const handleAddUrl = () => {
    ...
    url_div.setAttribute(
      'class',
      'grid gap-0 grid-rows-auto grid-cols-1 mobile:grid-cols-2 mobile:gap-4',
    )

    url_name.setAttribute('type', 'text')
    url_name.setAttribute('id', 'UrlName')
    url_name.setAttribute('maxlength', '5')
    url_name.setAttribute(
      'class',
      'mt-4 px-2.5 pb-1 w-full h-12 bg-[#17171b] text-left text-white rounded-lg',
    )
