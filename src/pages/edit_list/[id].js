                ...
                <div className="mx-4 mobile:mx-0">
                    <main className="mb-12">
                        ...
                        <div id="StepN" className="hidden">
                            ...
                            >
                                {layout.map((item) => {
                                    const currentItem = lists[0]?.result_location.find(
                                        (location) => location.i === item.i
                                    );
                                    ...
                                    const result = lists[0]?.result_content.find(
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        const newLayout = layout.filter(
                                                            (layoutItem) => layoutItem.i !== currentItem.i
                                                        );
                                                        setLayout(newLayout);

                                                        // 리스트를 제거한 후 defaultValue를 초기화
                                                        const newLists = [...lists];
                                                        newLists[0].result_location =
                                                            newLists[0].result_location.filter(
