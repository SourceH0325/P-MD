    ...
    <>
      ...
      <div className="mx-4 mobile:mx-0">
        <main className="mb-12">
         ...
         <button className='border-2 border-gray-600 hover:border-blue-600 rounded-lg px-4 py-2 transition-all font-semibold mx-auto block mt-4' onClick={() => router.back()}>돌아가기</button>
        </main>
      </div>
    </>
  )
